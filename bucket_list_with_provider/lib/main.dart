...
class HomePage extends StatelessWidget {
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      title: Text(
                        ...
                        style: TextStyle(
                          fontSize: 24,
                          color: bucket.isDone ? Colors.blueGrey : Colors.black,
                      ...
                      trailing: IconButton(
                        ...
                        onPressed: () {
                          showDeleteDialog(context, bucketService, index);
                        },
                      ),
                      onTap: () {
  ...
  void showDeleteDialog(
      BuildContext context, BucketService bucketService, int index) {
    showDialog(
      context: context,
      builder: (context) {
        return AlertDialog(
